...
/**
 * Given a string <b>pattern</b>, a string <b>replacementPattern</b> and
 * an input stream, this
 * class will replace all occurances of <b>pattern</b> with
 * <b>replacementPattern</b> in the inputstream. You can give multiple
...
public class StringReplaceReader extends FilterReader implements Cloneable
{
   ...
   * <B>Requires:</B> When this is called we have already have
   * read first character in pattern.<BR>
   * <B>Side Effects: </B> After attempt to find pattern, output
